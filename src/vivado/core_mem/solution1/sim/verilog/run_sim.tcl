# ==============================================================
# File generated on Wed Apr 03 12:27:38 +0530 2019
...
if {[file isfile mem.autotvin.dat]} {
	file delete -force mem.autotvin.dat
}

if {[file isfile mem.autotvout.dat]} {
	file delete -force mem.autotvout.dat
}
