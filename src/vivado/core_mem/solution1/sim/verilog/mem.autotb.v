...
`define AUTOTB_DUT      mem
`define AUTOTB_DUT_INST AESL_inst_mem
`define AUTOTB_TOP      apatb_mem_top
`define AUTOTB_LAT_RESULT_FILE "mem.result.lat.rb"
...
`define AESL_DEPTH_ma_V 1
`define AESL_DEPTH_data_V 1
`define AESL_DEPTH_flag_V 1
...
`define AUTOTB_TVIN_a_V_out_wrapc  "../tv/rtldatafile/rtl.mem.autotvin_a_V.dat"
`define AUTOTB_TVIN_ma_V_out_wrapc  "../tv/rtldatafile/rtl.mem.autotvin_ma_V.dat"
`define AUTOTB_TVIN_flag_V_out_wrapc  "../tv/rtldatafile/rtl.mem.autotvin_flag_V.dat"
`define AUTOTB_TVOUT_data_V  "../tv/cdatafile/c.mem.autotvout_data_V.dat"
`define AUTOTB_TVOUT_data_V_out_wrapc  "../tv/rtldatafile/rtl.mem.autotvout_data_V.dat"
module `AUTOTB_TOP;
...
parameter LENGTH_ma_V = 1;
parameter LENGTH_data_V = 1;
parameter LENGTH_flag_V = 1;
...
reg end_ma_V;
reg [31:0] size_ma_V;
reg [31:0] size_ma_V_backup;
reg end_flag_V;
reg [31:0] size_flag_V;
reg [31:0] size_flag_V_backup;
reg end_data_V;
reg [31:0] size_data_V;
reg [31:0] size_data_V_backup;
...
reg dump_tvout_finish_data_V;

initial begin : dump_tvout_runtime_sign_data_V
    integer fp;
    dump_tvout_finish_data_V = 0;
    fp = $fopen(`AUTOTB_TVOUT_data_V_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_data_V_out_wrapc);
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_data_V_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_data_V_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
