# ==============================================================
# File generated on Wed Apr 03 11:16:38 +0530 2019
...
HLS_SOURCES = ../../../test.cpp ../../../maincode.cpp
...
$(ObjDir)/maincode.o: ../../../maincode.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../maincode.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/maincode.d
