...
HD_PWD='D:/Workspace/phase2/src/vivado/core_mem_vivado/core_mem_vivado.runs/design_1_mem_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mem_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mem_0_0.tcl
